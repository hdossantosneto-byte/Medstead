...
const TABS = [
  ...
  { href: "/app/sales", label: "Accounts", match: (p: string) => p.startsWith("/app/sales") && !p.startsWith("/app/sales/events") },
  { href: "/app/sales/events", label: "Events", match: (p: string) => p.startsWith("/app/sales/events") },
];
